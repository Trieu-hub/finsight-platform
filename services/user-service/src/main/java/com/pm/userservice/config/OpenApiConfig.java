...
/**
 * OpenAPI metadata for user-service. Documents the service and declares the
...
public class OpenApiConfig {
    ...
    public OpenAPI userServiceOpenApi() {
        return new OpenAPI()
                .info(new Info()
                        .title("FinSight User Service API")
                        .description("User profile management (the caller's own profile only). "
