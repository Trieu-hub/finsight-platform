...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(CategoryResourceNotFoundException.class)
    public ResponseEntity<ErrorResponse> handleCategoryResourceNotFound(CategoryResourceNotFoundException ex) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(new ErrorResponse("CATEGORY_NOT_FOUND", ex.getMessage()));
    }

    @ExceptionHandler(CategoryConflictException.class)
    public ResponseEntity<ErrorResponse> handleCategoryConflict(CategoryConflictException ex) {
