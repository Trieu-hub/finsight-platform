...
/**
 * OpenAPI metadata for transaction-service. Documents the service and declares the
...
public class OpenApiConfig {
    ...
    public OpenAPI transactionServiceOpenApi() {
        return new OpenAPI()
                .info(new Info()
                        .title("FinSight Transaction Service API")
                        .description("Transactions, categories and spend summaries. "
