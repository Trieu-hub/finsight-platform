...
const en: Dict = {
  ...
  'luckyme.games.subtitle': 'Pick your game.',
  'luckyme.games.soon': 'Coming soon',
  'luckyme.games.available': 'Available',
  'luckyme.games.play': 'Play',
  ...
  'roulette.title': 'American Roulette',
  'roulette.back': 'Games',
  'roulette.loading': 'Loading the table…',
  'roulette.walletBalance': 'Wallet',
  'roulette.needWallet': 'You need a wallet with money in it to play.',
  'roulette.brokeWarning':
    'Your wallet is empty or in the red. Record some income before you can play again.',
  'roulette.recorded': 'Recorded as a transaction in your wallet.',
  'roulette.chip': 'Chip',
  'roulette.selectionHint':
    'Click pockets on the felt to build an inside bet — 1 = straight, 2 touching = split, a column of 3 = street, a 2×2 square = corner, 6 = six line.',
  'roulette.invalidSelection': 'Those pockets do not form a legal chip position.',
  'roulette.clearSelection': 'Clear',
  'roulette.placeBet': 'Bet {amount}',
  'roulette.pays': 'pays {odds}:1',
  'roulette.chance': '{pct}% to win',
  'roulette.bets': 'Bets on the table',
  'roulette.noBets': 'No bets yet.',
  'roulette.totalStake': 'Total stake',
  'roulette.clearBets': 'Clear bets',
  'roulette.remove': 'Remove bet',
  'roulette.spin': 'Spin',
  'roulette.spinning': 'No more bets…',
  'roulette.awaiting': 'Place your bets.',
  'roulette.netWin': '+{amount} credits',
  'roulette.netLoss': '−{amount} credits',
  'roulette.push': 'Break even',
  'roulette.history': 'Last spins',
  'roulette.edge':
    '38 pockets · house edge 5.26% (7.89% on the basket) · the money is as fake as everything else in this app',
  'roulette.ban.title': 'Locked out',
  'roulette.ban.desc':
    'Playing took your wallet {debt} into the red, so the table is closed to you for a while.',
  'roulette.ban.unlocksIn': 'Unlocks in',
  'roulette.ban.advice':
    'The lockout gets longer the deeper the debt, and longer again each time it happens. Record some income and come back.',
  'roulette.ban.tier.FIVE_MINUTES': 'Tier 1 — 5 minutes',
  'roulette.ban.tier.ONE_HOUR': 'Tier 2 — 1 hour',
  'roulette.ban.tier.SIX_HOURS': 'Tier 3 — 6 hours',
  'roulette.ban.tier.ONE_DAY': 'Tier 4 — 1 day',
  'roulette.ban.tier.ONE_WEEK': 'Tier 5 — 1 week',
  'roulette.bet.straight': 'Straight',
  'roulette.bet.split': 'Split',
  'roulette.bet.street': 'Street',
  'roulette.bet.trio': 'Trio',
  'roulette.bet.corner': 'Corner',
  'roulette.bet.basket': 'Basket',
  'roulette.bet.sixline': 'Six line',
  'roulette.bet.column': 'Column',
  'roulette.bet.dozen': 'Dozen',
  'roulette.bet.red': 'Red',
  'roulette.bet.black': 'Black',
  'roulette.bet.odd': 'Odd',
  'roulette.bet.even': 'Even',
  'roulette.bet.low': 'Low (1-18)',
  'roulette.bet.high': 'High (19-36)',
...
const vi: Dict = {
  ...
  'luckyme.games.subtitle': 'Chọn một trò chơi.',
  'luckyme.games.soon': 'Sắp ra mắt',
  'luckyme.games.available': 'Đã mở',
  'luckyme.games.play': 'Chơi ngay',
  'luckyme.game.roulette.name': 'Roulette',
  ...
  'roulette.title': 'Roulette Mỹ',
  'roulette.back': 'Trò chơi',
  'roulette.loading': 'Đang mở bàn…',
  'roulette.walletBalance': 'Ví',
  'roulette.needWallet': 'Bạn cần một ví có tiền thì mới chơi được.',
  'roulette.brokeWarning':
    'Ví của bạn đã hết tiền hoặc đang âm. Hãy ghi nhận thu nhập trước khi chơi tiếp.',
  'roulette.recorded': 'Đã ghi thành một giao dịch trong ví của bạn.',
  'roulette.chip': 'Phỉnh',
  'roulette.selectionHint':
    'Bấm vào các ô số trên bàn để tạo cược trong — 1 ô = straight, 2 ô kề nhau = split, một cột 3 ô = street, ô vuông 2×2 = corner, 6 ô = six line.',
  'roulette.invalidSelection': 'Các ô này không tạo thành một vị trí đặt phỉnh hợp lệ.',
  'roulette.clearSelection': 'Bỏ chọn',
  'roulette.placeBet': 'Đặt {amount}',
  'roulette.pays': 'trả {odds}:1',
  'roulette.chance': '{pct}% thắng',
  'roulette.bets': 'Cược trên bàn',
  'roulette.noBets': 'Chưa đặt cược nào.',
  'roulette.totalStake': 'Tổng cược',
  'roulette.clearBets': 'Xoá cược',
  'roulette.remove': 'Bỏ cược này',
  'roulette.spin': 'Quay',
  'roulette.spinning': 'Ngừng đặt cược…',
  'roulette.awaiting': 'Mời đặt cược.',
  'roulette.netWin': '+{amount} điểm',
  'roulette.netLoss': '−{amount} điểm',
  'roulette.push': 'Hoà vốn',
  'roulette.history': 'Các ván gần đây',
  'roulette.edge':
    '38 ô · lợi thế nhà cái 5,26% (7,89% với basket) · tiền ở đây ảo y như mọi con số khác trong app này',
  'roulette.ban.title': 'Bạn đã bị khoá',
  'roulette.ban.desc': 'Chơi đã khiến ví của bạn âm {debt}, nên bàn chơi tạm đóng với bạn.',
  'roulette.ban.unlocksIn': 'Mở lại sau',
  'roulette.ban.advice':
    'Nợ càng sâu thì khoá càng lâu, và mỗi lần tái phạm lại bị khoá lâu hơn nữa. Hãy ghi nhận thu nhập rồi quay lại.',
  'roulette.ban.tier.FIVE_MINUTES': 'Mức 1 — 5 phút',
  'roulette.ban.tier.ONE_HOUR': 'Mức 2 — 1 giờ',
  'roulette.ban.tier.SIX_HOURS': 'Mức 3 — 6 giờ',
  'roulette.ban.tier.ONE_DAY': 'Mức 4 — 1 ngày',
  'roulette.ban.tier.ONE_WEEK': 'Mức 5 — 1 tuần',
  'roulette.bet.straight': 'Straight (1 số)',
  'roulette.bet.split': 'Split (2 số)',
  'roulette.bet.street': 'Street (3 số)',
  'roulette.bet.trio': 'Trio (3 số)',
  'roulette.bet.corner': 'Corner (4 số)',
  'roulette.bet.basket': 'Basket (5 số)',
  'roulette.bet.sixline': 'Six line (6 số)',
  'roulette.bet.column': 'Cột (12 số)',
  'roulette.bet.dozen': 'Tá (12 số)',
  'roulette.bet.red': 'Đỏ',
  'roulette.bet.black': 'Đen',
  'roulette.bet.odd': 'Lẻ',
  'roulette.bet.even': 'Chẵn',
  'roulette.bet.low': 'Thấp (1-18)',
  'roulette.bet.high': 'Cao (19-36)',
