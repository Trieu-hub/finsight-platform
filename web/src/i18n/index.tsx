...
const en: Dict = {
  ...
  'luckyme.again': 'Flip again',
  'luckyme.red.title': 'Bad luck — red!',
  'luckyme.red.desc': 'Signing you out…',
  'luckyme.green.title': 'Lucky — green!',
  'luckyme.games.title': 'Mini games',
  'luckyme.games.empty': 'No games yet — coming soon.',
...
const vi: Dict = {
  ...
  'luckyme.again': 'Lật lại',
  'luckyme.red.title': 'Xui rồi — mặt đỏ!',
  'luckyme.red.desc': 'Đang đăng xuất bạn ra…',
  'luckyme.green.title': 'May mắn — mặt xanh!',
  'luckyme.games.title': 'Trò chơi mini',
  'luckyme.games.empty': 'Chưa có trò chơi nào — sắp ra mắt.',
