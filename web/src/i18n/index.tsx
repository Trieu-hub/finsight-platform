...
const en: Dict = {
  ...
  'outbox.pending': '{n} transaction(s) saved on this device, waiting to sync.',
  'outbox.full': 'Too many transactions are already waiting to sync. Reconnect before adding more.',
  'update.ready': 'A new version of Vernfy is ready.',
  'update.reload': 'Reload',
  'install.body': 'Install Vernfy for a full-screen app that opens straight from your home screen.',
  ...
  'tx.filterMonth': 'Filter by month',
  'tx.export': 'Export CSV',
  'tx.exporting': 'Exporting…',
  'tx.noTxMonth': 'No transactions this month.',
  'tx.expense': 'Expense',
  'tx.income': 'Income',
  ...
  'budget.showExpired': 'Show past budgets',
  ...
  'an.forecastHintModel': 'projected by month-end from your learned weekly pattern',
  'an.forecastRunRate': 'Current pace',
  'an.forecastModel': 'Trained model',
  'an.forecastRange': 'likely between {low} and {high}',
  'an.dayOf': 'Day {d} of {n}',
  ...
  'notif.push': 'Browser notifications',
  'notif.pushOn': 'On',
  'notif.pushOff': 'Turn on',
  'notif.pushDenied': 'Blocked in browser',
  'notif.email': 'Email alerts',
  'notif.emailOn': 'On',
  'notif.emailOff': 'Turn on',
  'notif.webhook': 'Webhook',
  'notif.webhookPlaceholder': 'https://your-server/hook',
  'notif.webhookSave': 'Save',
  'notif.webhookClear': 'Remove',
  'notif.webhookSecret': 'Signing secret — copy it now, it is not shown again:',
  'notif.digest': 'Send alerts',
  'notif.digestIMMEDIATE': 'As they happen',
  'notif.digestHOURLY': 'Hourly summary',
  'notif.digestDAILY': 'Daily summary',
  'notif.digestHint': 'Applies to email and webhook. The bell and browser notifications stay instant.',
  ...
  'import.subtitle':
    'Upload a CSV from your bank, tell Vernfy which column is which, then check the rows before they are written.',
  'import.file': 'CSV file',
  'import.loaded': '{file} — {n} rows read',
  'import.mapping': 'Columns',
  'import.hasHeader': 'The first row is a header',
  ...
  'import.dateOrder': 'Date order',
  'import.dmy': 'Day/Month/Year',
  'import.mdy': 'Month/Day/Year',
  'import.ymd': 'Year-Month-Day',
  'import.typeMode': 'Income or expense',
  'import.bySign': 'From the sign of the amount',
  'import.allExpense': 'Every row is an expense',
  'import.allIncome': 'Every row is income',
  'import.wallet': 'Wallet',
  'import.noWallet': 'Do not touch any wallet',
  'import.currency': 'Currency',
  'import.currencyLocked': 'The chosen wallet fixes the currency',
  'import.expenseCategory': 'Default expense category',
  'import.incomeCategory': 'Default income category',
  'import.budgetNote':
    'Imported expenses are charged to no budget: a whole statement dropped on one budget would blow it up. Assign them individually afterwards if you need to.',
  'import.preview': 'Check the rows',
  'import.counts': '{ok} ready · {bad} need attention',
  'import.colInclude': 'Import',
  'import.colDate': 'Date',
  'import.colDescription': 'Description',
  'import.colAmount': 'Amount',
  'import.colCategory': 'Category',
  'import.includeRow': 'Import row {n}',
  'import.categoryForRow': 'Category for row {n}',
  'import.previewCapped': 'Showing the first {shown} of {total} rows; all of them are imported.',
  'import.badDate': 'No date could be read',
  'import.badAmount': 'No amount could be read',
  'import.zeroAmount': 'The amount is zero',
  'import.noCategory': 'Pick a category',
  'import.import': 'Import {n} rows',
  'import.importing': 'Importing…',
  'import.done': 'Import finished',
  'import.result': '{imported} written · {duplicates} already there',
  'import.rowFailed': 'Row {n}: {message}',
}
...
const vi: Dict = {
  ...
  'outbox.pending': '{n} giao dịch đã lưu trên máy, đang chờ gửi lên.',
  'outbox.full': 'Đang có quá nhiều giao dịch chờ gửi. Hãy kết nối mạng trước khi thêm tiếp.',
  'update.ready': 'Đã có phiên bản Vernfy mới.',
  'update.reload': 'Tải lại',
  'install.body': 'Cài Vernfy để mở thẳng từ màn hình chính, chạy toàn màn hình như một ứng dụng.',
  'install.ios': 'Để cài: bấm nút Chia sẻ, rồi chọn “Thêm vào MH chính”.',
  'install.cta': 'Cài đặt',
  'install.dismiss': 'Để sau',
  ...
  'tx.saving': 'Đang lưu…',
  'tx.title': 'Giao dịch',
  'tx.allMonths': 'Tất cả các tháng',
  'tx.filterMonth': 'Lọc theo tháng',
  'tx.export': 'Xuất CSV',
  'tx.exporting': 'Đang xuất…',
  'tx.noTxMonth': 'Không có giao dịch trong tháng này.',
  'tx.expense': 'Chi',
  'tx.income': 'Thu',
  ...
  'budget.showExpired': 'Hiện ngân sách đã qua',
  'budget.expired': 'Đã qua',
  ...
  'an.forecastHintModel': 'dự kiến đến cuối tháng theo nếp chi theo tuần đã học được',
  'an.forecastRunRate': 'Tốc độ hiện tại',
  'an.forecastModel': 'Mô hình đã huấn luyện',
  'an.forecastRange': 'nhiều khả năng trong khoảng {low} – {high}',
  'an.dayOf': 'Ngày {d}/{n}',
  ...
  'notif.push': 'Thông báo trình duyệt',
  'notif.pushOn': 'Đang bật',
  'notif.pushOff': 'Bật',
  'notif.pushDenied': 'Đã chặn ở trình duyệt',
  'notif.email': 'Cảnh báo qua email',
  'notif.emailOn': 'Đang bật',
  'notif.emailOff': 'Bật',
  'notif.webhook': 'Webhook',
  'notif.webhookPlaceholder': 'https://may-chu-cua-ban/hook',
  'notif.webhookSave': 'Lưu',
  'notif.webhookClear': 'Gỡ',
  'notif.webhookSecret': 'Khoá ký — sao chép ngay, sẽ không hiện lại:',
  'notif.digest': 'Gửi cảnh báo',
  'notif.digestIMMEDIATE': 'Ngay khi xảy ra',
  'notif.digestHOURLY': 'Gộp mỗi giờ',
  'notif.digestDAILY': 'Gộp mỗi ngày',
  'notif.digestHint': 'Áp dụng cho email và webhook. Chuông và thông báo trình duyệt vẫn tức thì.',
  ...
  'import.title': 'Nhập sao kê',
  'import.subtitle':
    'Tải lên file CSV từ ngân hàng, chỉ cho Vernfy biết cột nào là gì, rồi soát lại các dòng trước khi ghi.',
  'import.file': 'File CSV',
  'import.loaded': '{file} — đọc được {n} dòng',
  'import.mapping': 'Ánh xạ cột',
  'import.hasHeader': 'Dòng đầu là tiêu đề cột',
  'import.dateColumn': 'Cột ngày',
  'import.amountColumn': 'Cột số tiền',
  'import.descColumn': 'Cột nội dung',
  'import.columnN': 'Cột {n}',
  'import.dateOrder': 'Thứ tự ngày',
  'import.dmy': 'Ngày/Tháng/Năm',
  'import.mdy': 'Tháng/Ngày/Năm',
  'import.ymd': 'Năm-Tháng-Ngày',
  'import.typeMode': 'Thu hay chi',
  'import.bySign': 'Theo dấu của số tiền',
  'import.allExpense': 'Mọi dòng đều là khoản chi',
  'import.allIncome': 'Mọi dòng đều là khoản thu',
  'import.wallet': 'Ví',
  'import.noWallet': 'Không đụng tới ví nào',
  'import.currency': 'Tiền tệ',
  'import.currencyLocked': 'Ví đã chọn quy định tiền tệ',
  'import.expenseCategory': 'Danh mục chi mặc định',
  'import.incomeCategory': 'Danh mục thu mặc định',
  'import.budgetNote':
    'Khoản chi nhập vào không trừ ngân sách nào: dồn cả bản sao kê vào một ngân sách sẽ thổi bay ngân sách đó. Cần thì gán lại từng khoản sau.',
  'import.preview': 'Soát lại các dòng',
  'import.counts': '{ok} sẵn sàng · {bad} cần xem lại',
  'import.colInclude': 'Nhập',
  'import.colDate': 'Ngày',
  'import.colDescription': 'Nội dung',
  'import.colAmount': 'Số tiền',
  'import.colCategory': 'Danh mục',
  'import.includeRow': 'Nhập dòng {n}',
  'import.categoryForRow': 'Danh mục cho dòng {n}',
  'import.previewCapped': 'Đang hiện {shown} dòng đầu trong {total}; tất cả đều được nhập.',
  'import.badDate': 'Không đọc được ngày',
  'import.badAmount': 'Không đọc được số tiền',
  'import.zeroAmount': 'Số tiền bằng 0',
  'import.noCategory': 'Hãy chọn danh mục',
  'import.import': 'Nhập {n} dòng',
  'import.importing': 'Đang nhập…',
  'import.done': 'Nhập xong',
  'import.result': '{imported} dòng đã ghi · {duplicates} dòng đã có sẵn',
  'import.rowFailed': 'Dòng {n}: {message}',
}
